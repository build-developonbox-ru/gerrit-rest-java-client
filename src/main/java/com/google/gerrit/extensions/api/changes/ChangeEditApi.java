...
public interface ChangeEditApi {
   ...
   * created based on the current patch set of the change.
   *
   * @param changeEditMessageInput the desired change edit message
   * @throws RestApiException if the commit message couldn't be modified
   */
  void modifyCommitMessage(ChangeEditMessageInput changeEditMessageInput) throws RestApiException;
